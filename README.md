...
| | | |
| :-- | --: | :-- |
| **Test methods** | **9,115** | 8,508 `@Test` + 607 `@ParameterizedTest`, across **293** test classes and the **2,164** `@Nested` groups inside them |
...
across all 366 test files. Nothing is quarantined, skipped-and-forgotten, or
