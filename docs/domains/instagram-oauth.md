...
> **As-built note:** the callbacks specified below shipped — see `InstagramDataDeletionService` (deferred deletion honored once active collaborations end) and `MetaSignedRequestService` in `legal/`.
