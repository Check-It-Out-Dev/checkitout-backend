...
flowchart LR
  ...
  subgraph n16["OpportunityStatusUnitTest$JsonSerialization"]
    direction LR
    n17["#35;fromStringShouldParseMixedCase()"]:::demoted
    n18["#35;fromStringShouldParseLowercase()"]
  ...
  n40["RegisterUserRequestUnitTest$CompanyDataValidati…"]
...
| --- | --- | --- |
| `FutureOrPresentDateValidatorUnitTest$DirectValidatorTests` | 21 | 3 tests |
| `ActiveCooperationControllerUnitTest$PaginationTests` | 20 | 4 tests |
| `AppliedOpportunityEnumsUnitTest$OpportunityStatusEnumTests$GetNextStatusTests` | 17 | 9 tests |
...
| `CustomErrorControllerUnitTest$SpecificErrorLoggingTests` | 12 | 11 tests |
...
| `AssessmentResultUnitTest$SuccessFactoryMethodTests` | 10 | 3 tests |
...
| `RedisUserCacheUnitTest$GetAccountStatusTests` | 10 | 3 tests |
...
| `CommonJwtUnitTest$CreateTokenWithClaimsTests` | 9 | 4 tests |
...
| `SecretsServiceUnitTest$EdgeCaseTests` | 9 | 7 tests |
...
| `AssessmentResultUnitTest$AllowedFactoryMethodTests` | 8 | 3 tests |
...
| `UserPackageUnitTest$AccountStatusEnumTests$CanTransitionToTests` | 8 | 7 tests |
...
| `CommonJwtUnitTest$ValidateTokenTests` | 7 | 5 tests |
| `CommonSafetyUnitTest$DangerousConfigurationDatabaseTests` | 7 | 8 tests |
| `CommonSafetyUnitTest$MaskSensitiveUrlTests` | 7 | 5 tests |
...
| `FutureOrPresentDateValidatorUnitTest$EdgeCaseTests` | 7 | 2 tests |
...
| `CommonSafetyUnitTest$DatabaseUrlPatternMatchingTests` | 6 | 5 tests |
| `CommonSafetyUnitTest$EdgeCasesTests` | 6 | 8 tests |
| `CommonValidatorUnitTest$CheckReCaptchaTests` | 6 | 6 tests |
| `CorsLoggingFilterUnitTest$EdgeCaseTests` | 6 | 5 tests |
| `CorsLoggingFilterUnitTest$ResponseHeaderLoggingTests` | 6 | 10 tests |
...
| `PiiMaskingUtilsUnitTest$PseudonymousIdTests` | 6 | 4 tests |
...
| `CommonValidatorUnitTest$EdgeCasesTests` | 5 | 5 tests |
...
| `CustomErrorControllerUnitTest$EdgeCaseTests` | 5 | 5 tests |
...
| `InstagramServiceUnitTest$PrivacyUtilitiesTests` | 5 | 6 tests |
| `InstagramSocialAuthUnitTest$InstagramServiceTests$AnonymizeIdTests` | 5 | 4 tests |
| `InstagramSocialAuthUnitTest$InstagramServiceTests$MaskUsernameTests` | 5 | 3 tests |
| `MetadataUnitTest$ConsentActionEnumTests` | 5 | 5 tests |
...
| `RedisUserCacheUnitTest$IsUserActiveTests` | 5 | 6 tests |
...
| `ActiveCooperationControllerUnitTest$EdgeCaseTests` | 4 | 4 tests |
| `AdminControllerUnitTest$SetUserClaimsTests$AuthorizationTests` | 4 | 3 tests |
| `FileManagementControllerUnitTest$WebhookControllerEdgeCaseTests` | 4 | 2 tests |
...
| `AuthDtoCompleteUnitTest$CrossFieldValidationTests` | 4 | 4 tests |
...
| `UserControllerUnitTest$GetUserTypeListTests` | 3 | 1 tests |
...
| `AuthDtoMoreUnitTest$RecaptchaRequestAdditionalTests` | 3 | 1 tests |
...
| `CommonJwtUnitTest$SecurityTests` | 3 | 2 tests |
...
| `CommonSafetyUnitTest$UrlMaskingPatternsTests` | 3 | 1 tests |
| `CommonValidatorUnitTest$CheckFirebaseAuthTests` | 3 | 4 tests |
| `CommonValidatorUnitTest$ValidateAllServicesTests` | 3 | 4 tests |
| `ConsentAndAddressUnitTest$ConsentActionEnumTests$ActionTypeHelperMethodsTests` | 3 | 1 tests |
...
| `MetadataUnitTest$AccountStatusEnumTests` | 3 | 4 tests |
...
| `TokenEncryptionServiceUnitTest$ValidateKMSServiceTests` | 3 | 3 tests |
...
| `UserCacheServiceUnitTest$RedisUserCacheTests$IsUserActiveTests` | 3 | 4 tests |
...
| `ConsentControllerUnitTest$ResponseStructureTests` | 2 | 2 tests |
...
| `OpportunityStatusUnitTest$GetNextStatusInvalidTransitions` | 2 | 1 tests |
...
| `ConsentServiceUnitTest$ConsentActionEnumTests` | 2 | 2 tests |
...
| `EncryptionServicesUnitTest$TokenEncryptionServiceTests$ValidateKMSServiceTests` | 2 | 3 tests |
...
| `InstagramServiceUnitTest$RefreshLongLivedTokenTests` | 2 | 1 tests |
...
| `InstagramSocialAuthUnitTest$InstagramServiceTests$RefreshLongLivedTokenTests` | 2 | 2 tests |
...
| `RecaptchaServiceUnitTest$VerifyTokenDisabledTests` | 2 | 3 tests |
...
| `SecretsServiceUnitTest$GetSecretCachingTests` | 2 | 2 tests |
...
| `UserCacheServiceUnitTest$RedisUserCacheTests$GetAccountStatusTests` | 2 | 5 tests |
...
| `UserControllerUnitTest$FindPaginatedTests` | 1 | 1 tests |
...
| `AuthDtoUnitTest$RecaptchaRequestTests` | 1 | 1 tests |
...
| `CommonValidatorUnitTest$CheckGoogleCloudStorageTests` | 1 | 2 tests |
...
| `CorsLoggingFilterUnitTest$RejectionReasonDeterminationTests` | 1 | 1 tests |
...
| `InMemoryUserCacheUnitTest$CleanExpiredTests` | 1 | 2 tests |
...
| `RedisUserCacheUnitTest$EvictTests` | 1 | 1 tests |
| `RedisUserCacheUnitTest$IntegrationLikeTests` | 1 | 2 tests |
| `RedisUserCacheUnitTest$TtlConfigurationTests` | 1 | 1 tests |
| `RegisterUserRequestUnitTest$AddressDataValidationTests` | 1 | 2 tests |
| `RegisterUserRequestUnitTest$CompanyDataValidationTests` | 1 | 3 tests |
...
| `SecretsServiceUnitTest$ClearCacheTests` | 1 | 1 tests |
