...
#
# The same script as the frontend repository's tools/ci/publish-pages.sh, copied rather than
# fetched: a publish step that has to clone another repository before it can publish is a publish
# step with one more way to fail. Keep the two in step when either changes.
#
