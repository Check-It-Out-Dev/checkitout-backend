...
/**
 * Entity representing a file attachment on a support ticket.
 */
@Entity
...
public class TicketAttachment {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ticket_attachment_generator")
    @SequenceGenerator(
        name = "ticket_attachment_generator",
        sequenceName = "ticket_attachment_seq",
        schema = "public",
        allocationSize = 50,
        initialValue = 1
    )
