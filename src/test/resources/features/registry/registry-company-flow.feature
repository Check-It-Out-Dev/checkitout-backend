...
Feature: Registry Company Flow
  ...
  # =========================================================================
  # GROUP 2: CONFIRM + AUTO-ACTIVATION
  # =========================================================================
  ...
  # 204, not 200. It used to answer ResponseEntity.ok(null), which is a 200 with no body and no
  # Content-Type -- a client reading it as JSON fails at character zero, and the fuzz tier reported
  # exactly that. "200, may be null" is not something HTTP can say; 204 is.
  @registry @get-data
  ...
  # =========================================================================
  # GROUP 4: PERMISSION ENFORCEMENT
  # =========================================================================
