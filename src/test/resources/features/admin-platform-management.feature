...
Feature: Admin Platform Management Operations (CONSOLIDATED)
  ...
  #   - Influencer: E2EINFLUENCERUID000000000001 (norbertmarchewka - Instagram OAuth)
  #
  ...
  Scenario: Admin ban affects user sessions in real-time
    ...
    # ===== ADMIN BANS COMPANY1 =====
    Given the target user "E2ECOMPANYUID000000000000001" is synced from Firestore
    When the admin bans user "E2ECOMPANYUID000000000000001" with reason "Multi-actor E2E test ban"
    Then the response status should be 200
    And the user "E2ECOMPANYUID000000000000001" should have status "BANNED"
    ...
    When the admin unbans user "E2ECOMPANYUID000000000000001"
    Then the response status should be 200
    And the user "E2ECOMPANYUID000000000000001" should have status "ACTIVE"
    ...
    When the admin sets user "E2ECOMPANYUID000000000000001" status to "ACTIVE"
    Then the response status should be 200
  ...
  Scenario: Admin performs comprehensive system monitoring and statistics review
    ...
    When "Admin" views uploads for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found
    ...
    When "Admin" views consent info for user "E2ECOMPANYUID000000000000001"
    Then the response status should be 200
    ...
    When "Admin" views GDPR retention for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ----- User Location Export (Read-Only Check) -----
    When "Admin" requests location export for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found
  ...
  Scenario: Admin performs comprehensive user data management operations
    ...
    # ===== SYNC TARGET USERS =====
    Given the target user "E2ECOMPANYUID000000000000001" is synced from Firestore
    And the target user "E2EINFLUENCERUID000000000001" is synced from Firestore

    # ========== SECTION 1: USER PROFILE VIEWING ==========

    # ----- View Company User Profile -----
    When the admin views user "E2ECOMPANYUID000000000000001" profile
    Then the response status should be 200
    ...
    When the admin views user "E2EINFLUENCERUID000000000001" profile
    Then the response status should be 200
    And the response should contain the user's email
    ...
    When "Admin" views preferences for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ----- Patch User Preferences (dark mode) -----
    When "Admin" patches preferences for target user "E2ECOMPANYUID000000000000001" with:
    ...
    When "Admin" checks deletion eligibility for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ----- Check Deletion Eligibility for Influencer User -----
    When "Admin" checks deletion eligibility for target user "E2EINFLUENCERUID000000000001"
    Then the response should be successful or not found

    # ========== SECTION 4: PREMIUM STATUS MANAGEMENT ==========

    # ----- Set Premium Status ON -----
    When "Admin" sets premium status to true for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ----- Set Premium Status OFF (restore) -----
    When "Admin" sets premium status to false for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ========== SECTION 5: ADDRESS MANAGEMENT ==========

    # ----- View User Addresses -----
    When "Admin" views addresses for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ----- View User Primary Address -----
    When "Admin" views primary address for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ----- Create Address for User -----
    When "Admin" creates address for target user "E2ECOMPANYUID000000000000001" with:
    ...
    When the admin sets user "E2ECOMPANYUID000000000000001" status to "INACTIVE"
    Then the response status should be 200
    And the user "E2ECOMPANYUID000000000000001" should have status "INACTIVE"

    When the admin sets user "E2ECOMPANYUID000000000000001" status to "IN_VALIDATION"
    Then the response status should be 200
    And the user "E2ECOMPANYUID000000000000001" should have status "IN_VALIDATION"
  ...
  Scenario: Admin GDPR and Consent management operations
    ...
    When "Admin" views consent info for target user "E2ECOMPANYUID000000000000001"
    Then the response should be successful or not found

    # ========== SECTION 9: CONSENT HISTORY ==========

    # ----- View Consent History - Happy Path -----
    When "Admin" views consent history for target user "E2ECOMPANYUID000000000000001" type "TERMS_SERVICE"
    Then the response should be successful or not found

    # ----- View Consent History - Non-existent type -----
    When "Admin" views consent history for target user "E2ECOMPANYUID000000000000001" type "NON_EXISTENT_TYPE"
    Then the response should be successful or not found
